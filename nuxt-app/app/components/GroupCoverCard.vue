...
const covers = computed(() => props.group.covers.slice(0, 4))
</script>

<template>
  <NuxtLink
    :to="`/memes/${group.id}`"
    class="group relative block overflow-hidden rounded-2xl border border-default bg-elevated transition-colors hover:border-primary/40"
  >
